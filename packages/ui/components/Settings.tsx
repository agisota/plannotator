...
import { type BearSettings, getBearSettings, saveBearSettings } from '../utils/bear';
import {
                        ...
                        <>
                          ...
                          <div className="space-y-2">
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                handlePermissionModeChange(e.target.value as PermissionMode)
                              }
                                ...
                                <>
                                  {agent.switchTo !== 'custom' &&
                                    ...
                                    !availableAgents.some(
                                      (a) => a.id.toLowerCase() === agent.switchTo.toLowerCase(),
                                    ) && (
                    ...
                    <>
                        ...
                        {planSave.enabled && (
                          <div className="space-y-1.5 pl-0.5">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handlePlanSaveChange({ customPath: e.target.value || null })
                              }
                      ...
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleDefaultNotesAppChange(e.target.value as DefaultNotesApp)
                          }
                          className="w-full px-3 py-2 bg-muted rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-primary/50 cursor-pointer"
                        >
